;(function(){
  function ensureStyle(){
    ...
    style.textContent = [
      ...
      '.shellTitle{font-size:12px;color:var(--muted,#6b7280);background:#f1f5f9;border:1px solid #e2e8f0;padding:5px 10px;border-radius:999px;white-space:nowrap}',
      '.shellRight{display:flex;align-items:center;gap:10px;flex-wrap:wrap}',
      '.shellBadge{font-size:12px;color:var(--muted,#6b7280);background:#f1f5f9;border:1px solid #e2e8f0;padding:5px 10px;border-radius:999px;white-space:nowrap}',
      '.shellStatus{font-size:12px;display:flex;align-items:center;gap:8px;color:var(--muted,#6b7280)}',
      ...
      '.shellGroupLabel{font-size:12px;color:var(--muted,#6b7280);font-weight:800;padding:0 6px;white-space:nowrap}',
