...
def follow_agent(agent_name: str) -> Dict:
    ...
    url = f"{API_BASE}/agents/{requests.utils.quote(agent_name)}/follow"
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Follow Moltbook agent")
    parser.add_argument("--agent_name", required=True, help="Agent name to follow")
    args = parser.parse_args()
    
    result = follow_agent(args.agent_name)
