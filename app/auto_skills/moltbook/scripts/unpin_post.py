...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Unpin Moltbook post")
    parser.add_argument("--post_id", required=True, help="Post ID")
    args = parser.parse_args()
    
    result = unpin_post(args.post_id)
