...
def get_comments(post_id: str, sort: str = "top") -> Dict:
    ...
    url = f"{API_BASE}/posts/{post_id}/comments?sort={sort}"
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Get comments for Moltbook post")
    parser.add_argument("--post_id", required=True, help="Post ID")
    parser.add_argument("--sort", default="top", help="Sort order: top, new, controversial")
    args = parser.parse_args()
    
    result = get_comments(args.post_id, args.sort)
