...
def get_submolt_info(submolt_name: str) -> Dict:
    ...
    url = f"{API_BASE}/submolts/{requests.utils.quote(submolt_name)}"
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Get Moltbook submolt info")
    parser.add_argument("--submolt_name", required=True, help="Submolt name")
    args = parser.parse_args()
    
    result = get_submolt_info(args.submolt_name)
