...
def excel_sum_column(file_path: str, column_letter: str, start_row: int = 1, end_row: Optional[int] = None, sheet_name: str = "Sheet1") -> float:
    """
    计算指定列的总和
    ...
    try:
        ...
        raise Exception(f"计算Excel列总和失败: {str(e)}")